...
public class PhotoController extends BaseController {
	...
	public Object LivePhoto() throws Exception {
		...
		String pathimg = PathUtil.getProjectpath() + Const.LIVEPHOTOS + year + "//" + month + "//" + UUID + ".jpg";
		...
		map.put("imgpath", Const.LIVEPHOTOS + year + "//" + month + "//" + UUID + ".jpg");
		map.put("result", errInfo);
		return map;
	}
}
