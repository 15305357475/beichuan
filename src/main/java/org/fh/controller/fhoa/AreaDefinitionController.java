...
/**
 * 说明：区域配置处理类 作者：f-sci 授权：bsic
 */
@Controller
@RequestMapping("/areadefinition")
public class AreaDefinitionController extends BaseController {
	...
	@RequiresPermissions("areadefinition:list")
	@ResponseBody
	public Object listAllDict() throws Exception {
		Map<String, String> map = new HashMap<String, String>();
		String errInfo = "success";
		JSONArray arr = JSONArray.fromObject(dictionariesService.listAllDictForArea("881f2094fda94b289eb42325888d7b08"));
