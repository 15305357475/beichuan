...
public interface DepartmentMapper{
	 ...
	 * @throws Exception
	 */
	public List<PageData> listAllDepartmentToSelect2(String parentId, List<PageData> zdepartmentPdList) throws Exception;
	 ...
	 * @throws Exception
	 */
	public PageData RecursionUpwardById(String DEPARTMENT_ID)throws Exception;
}
