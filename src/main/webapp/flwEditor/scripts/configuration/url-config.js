...
FLOWABLE.APP_URL = {
    ...
    getFhadminDeploymentJsonUrl: function (fhadminId) {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/fhadmin-deployment/'+fhadminId+'/model-json';
    },
    
    getFhadminDefinitionsJsonUrl: function (fhadminId) {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/fhadmin-definitions/'+fhadminId+'/model-json';
    },
    
    getFhadminCallbackJsonUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/fhadmin-callback';
    },
